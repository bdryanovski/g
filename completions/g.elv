...
set edit:completion:arg-completer[g] = {|@words|
    ...
    var completions = [
        ...
        &'g;commit'= {
            ...
            cand -s 'Add Signed-off-by trailer'
            cand --signoff 'Add Signed-off-by trailer'
            cand -S 'GPG-sign the commit'
            cand --gpg-sign 'GPG-sign the commit'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help'
            cand --help 'Print help'
        ...
        &'g;workflow'= {
            ...
            cand -V 'Print version'
            cand --version 'Print version'
            cand start 'Start a new branch using workflow rules'
            cand finish 'Finish the current branch (merge to target)'
            cand sync 'Update branch from its source'
            cand publish 'Push branch and create/update PR'
            cand status 'Show workflow status of current branch'
            cand list 'List all available workflows'
            cand info 'Show detailed workflow information'
            cand use 'Switch to a different workflow'
            cand create 'Create a new workflow interactively'
            cand edit 'Edit an existing workflow'
            cand init 'Initialize workflow configuration'
            cand validate 'Validate workflow configuration'
            cand clone 'Clone a workflow with a new name'
            cand export 'Export workflow configuration to TOML'
            cand import 'Import workflow from a TOML file'
            cand help 'Print this message or the help of the given subcommand(s)'
        }
        &'g;workflow;start'= {
            cand --from 'Override the source branch'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --no-verify 'Skip validation checks'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;finish'= {
            cand --strategy 'Override the merge strategy'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --no-delete 'Don''t delete the branch after merge'
            cand --no-tag 'Don''t create a tag even if configured'
            cand --no-verify 'Skip pre-finish hooks'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;sync'= {
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --rebase 'Force rebase even if merge is the default strategy'
            cand --merge 'Force merge even if rebase is the default strategy'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;publish'= {
            cand --title 'PR title (defaults to branch name)'
            cand --body 'PR body'
            cand --reviewers 'Add reviewers (comma-separated)'
            cand --labels 'Add labels (comma-separated)'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --draft 'Create PR as draft'
            cand --no-verify 'Skip on_publish hooks'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;use'= {
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --local 'Set for this repository only (saves to .g/workflow.toml)'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;create'= {
            cand --from 'Start from a preset'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --local 'Save to repo-local config (.g/workflow.toml)'
            cand --no-interactive 'Skip interactive wizard, save defaults immediately'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
            cand -V 'Print version'
        ...
        &'g;workflow;edit'= {
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --raw 'Edit raw TOML in $EDITOR'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
        ...
        &'g;workflow;init'= {
            cand --preset 'Use a preset as starting point'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --local 'Create .g/ folder in repository for team-shared config'
            cand --no-interactive 'Skip interactive setup'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand -h 'Print help (see more with ''--help'')'
            cand --help 'Print help (see more with ''--help'')'
            cand -V 'Print version'
        ...
        &'g;workflow;validate'= {
            cand --workflow 'Workflow name to validate (within config)'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
        ...
        &'g;workflow;export'= {
            cand -o 'Output file (defaults to stdout)'
            cand --output 'Output file (defaults to stdout)'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --dry-run 'Preview what commands would run without making any changes'
            cand --no-interactive 'Disable all interactive TUI prompts; use defaults or require --flag values. Useful for scripting and CI environments'
        ...
        &'g;workflow;import'= {
            cand --name 'Override workflow name'
            cand -C 'Run as if git was started in <path>'
            cand -c 'Override a configuration value (key=value)'
            cand --local 'Save to repo-local config (.g/workflow.toml)'
            cand --dry-run 'Preview what commands would run without making any changes'
        ...
        &'g;workflow;help;start'= {
        }
        &'g;workflow;help;finish'= {
        }
        &'g;workflow;help;sync'= {
        }
        &'g;workflow;help;publish'= {
        }
        &'g;workflow;help;status'= {
        }
        &'g;workflow;help;list'= {
        }
        &'g;workflow;help;info'= {
        }
        &'g;workflow;help;use'= {
        }
        &'g;workflow;help;create'= {
        }
        &'g;workflow;help;edit'= {
        }
        &'g;workflow;help;init'= {
        }
        &'g;workflow;help;validate'= {
        }
        &'g;workflow;help;clone'= {
        }
        &'g;workflow;help;export'= {
        }
        &'g;workflow;help;import'= {
        }
        ...
        &'g;help;workflow;start'= {
        }
        &'g;help;workflow;finish'= {
        }
        &'g;help;workflow;sync'= {
        }
        &'g;help;workflow;publish'= {
        }
        &'g;help;workflow;status'= {
        }
        &'g;help;workflow;list'= {
        }
        &'g;help;workflow;info'= {
        }
        &'g;help;workflow;use'= {
        }
        &'g;help;workflow;create'= {
        }
        &'g;help;workflow;edit'= {
        }
        &'g;help;workflow;init'= {
        }
        &'g;help;workflow;validate'= {
        }
        &'g;help;workflow;clone'= {
        }
