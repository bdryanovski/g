...
//! uses it to regenerate three classes of artifact every time `src/cli.rs`
//! changes:
//!
...
//!
//! **No manual steps required.**  Edit a `///` comment in `cli.rs`, run
//! `cargo build`, and all three are regenerated in place.
//!
...
description: >-
  ...
  Auto-generated from src/cli.rs — do not edit this file directly.
order: 99
---

<!-- This file is auto-generated by build.rs from src/cli.rs.       -->
