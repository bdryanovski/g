...
- **Workspaces** — parallel checkouts with `git worktree`, friendly names, interactive fuzzy switching, and container or sibling directory layouts. Run `g workspace init` to reorganise an existing repo.
